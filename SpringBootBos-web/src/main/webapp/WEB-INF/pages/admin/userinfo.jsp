		...
		$.ajax({
			 ...
			 success: function(msg){
				 ...
				 for(var i=0;i<msg.length;i++){
					//增加子标签数据
				     $("#roldTd").append('<input type="checkbox" value="'+msg[i].id+'" id="'+msg[i].id+'" name="roleId"><label for="'+msg[i].id+'">'+msg[i].name+'</label>');
				 }
...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="userForm" method="post" action="/addUser.action" >
           <table class="table-edit"  width="95%" align="center">
				...
				<tr>
	           	...
	           	<tr>
		           	<td>选择角色:</td>
		           	<td colspan="3" id="roldTd">
						<!-- <input type="checkbox" value="测试数据" id="test" name="roleId">
						<label for="test">测试数据</label> -->
					</td>
				</tr>
           </table>
       </form>
