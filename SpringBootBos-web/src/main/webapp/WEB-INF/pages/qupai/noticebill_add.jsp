...
<script type="text/javascript">
	...
	function ajaxCheckTelephone(){
		//得到电话号码的值
		var telephone=$("input[name=telephone]").val();
		//alert(telephone);
		//进行发送ajax请求
		$.ajax({
				  url: "/noticeBill/ajaxCheckCustomerTelephone.action",
				  async: false,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="/noticeBill/autoSaveDivierOrder.action" method="post">
			<table class="table-edit" width="95%" align="center">
				...
				<tr>
					<td>来电号码:</td>
					<td><input type="text" onblur="ajaxCheckTelephone()" class="easyui-validatebox" name="telephone"
						required="true" /></td>
					<td>客户编号:</td>
