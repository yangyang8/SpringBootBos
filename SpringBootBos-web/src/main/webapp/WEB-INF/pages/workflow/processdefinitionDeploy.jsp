...
<form action="/process/processdefinitionDeploy.action" theme="simple" method="post" enctype="multipart/form-data" id="uploadForm">
	<table class="table-edit" width="100%" >
		...
		<tr>
			<td colspan="2">
				...
				<!-- <button type="submit" value="发布新流程"  name="发布新流程"/>  -->
			</td>
		</tr>
	</table>
</form>
